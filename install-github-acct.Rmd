...
A few tips, which sadly tend to contradict each other:
  ...
  * Avoid uppercase letters. GitHub names are case insensitive but using all lowercase will help in situations where character matching will be done based on usernames (e.g. in a class roster). If you want visual separation between letters in your username, use hyphens instead of camelCase.
