...
## Activating the git credential store

### You might not need to do anything!

As of October 2020, if you install Git using the [methods recommended here in Happy Git](#install-git), it is likely that Git will use a credential helper provided by your operating system.
Most users do not need to do anything special in order to cache your GitHub credentials.
Of course, you will have to provide this information at least once, but your system is probably already set up to cache this information.
