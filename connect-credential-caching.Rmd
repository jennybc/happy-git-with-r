...
You may proceed when
  ...
  * You know the GitHub repo is setup as a remote. In a shell (Appendix \@ref(shell)) working directory set to the local Git repo, enter:
    ...
    Here we confirm that the local `main` branch is tracking your GitHub main branch (`origin/main`). Gibberish? Just check that your output looks similar to mine:
