...
The first two commands from 7.0 (above) using `git config --global use.[something]` return nothing in the terminal. You can check that Git understood what you typed by looking at the output of `git config --global --list`.
