...
If you're nervous about command line Git, you update your fork on GitHub purely via the browser: In your forked repo, you should see a message that you are behind the original repository by a certain number of commits. To bring in these changes, click: "New Pull Request", "switching the base", "Create new pull request". Add a title, then click "Create pull request", "Merge pull request", and finally "Confirm merge".

Then, in your local setup, pull to get the commits into your local repo. 
