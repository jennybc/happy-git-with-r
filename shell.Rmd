...
#### Accessing Git shell outside of Rstudio (Windows)

Sometimes you will need to run git shell outside of RStudio, which can be useful in doing some file operations within a repository. The easiest way to open up a Git Shell outside of RStudio is to click the "Git" menu under the windows menu, and select "Git Bash":
