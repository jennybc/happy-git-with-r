...
On a Mac, you can use Spotlight Search (cmd-space) to search "Terminal". Opening Terminal brings you to a bash shell opened to your home directory `~/` which is an alias for `/Users/YOURUSERNAME`. You should see a blinking cursor.

<!--- 
- how to get into a shell in general, i.e. not just from within RStudio. 
- sudo
--->
...
If you have administrative rights on your computer, prefacing any command with `sudo` will ask you force the command to run after asking for your password. If you need to change administrative priviledges or your password, [apple support pages](https://support.apple.com/en-us/HT204012) can be helpful.
