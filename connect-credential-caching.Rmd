...
For Ubuntu and Mint credential caching can be [achieved with libsecret](https://www.softwaredeveloper.blog/git-credential-storage-libsecret) via the commands:
