...
In RStudio, start a new Project:
  ...
  * *New Project > New Project from Git Repo*. In the "URL of your GitHub repository" paste the URL of your new GitHub repository. It will be something like this `https://github.com/jennybc/myrepo.git`.
  * Be intentional about where you create this Project.
  * Suggest you "Open in new session".
  * Click "Ok" to create a new directory, which will be all of these things:
