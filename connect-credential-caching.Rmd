...
*As of November 2020, gitcreds is available on CRAN. A future release of usethis (2.0.0) will depend on gitcreds, via the [gh package](https://gh.r-lib.org).*

If you don't have gitcreds installed, install via `devtools::install_github("r-lib/gitcreds")` or via `install.packages("gitcreds")`.
